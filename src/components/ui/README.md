...
Primitive UI components — the base layer. Button, Input, Select, Checkbox, Radio, Switch, Badge, Avatar, Icon. No business logic, no data fetching, no knowledge of any module.
